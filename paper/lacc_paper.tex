...
\begin{enumerate}[label=(\arabic*),leftmargin=*]
    ...
    \item \textbf{Huấn luyện end-to-end}: đề xuất \textit{Phonological Consistency Loss} --- một auxiliary loss huấn luyện mô hình dự đoán thanh điệu từ hidden states, tạo cầu nối trực tiếp giữa training và inference: mô hình học mã hóa tone trong quá trình huấn luyện, và chính classifier đó được dùng làm tone probe khi nén.
\end{enumerate}
...
\begin{table}[H]
\centering
\caption{Kết quả pilot của mô hình scoring tiếng Việt nhỏ sau 30 bước cập nhật. Mũi tên $\downarrow$/$\uparrow$ biểu thị chiều tối ưu.}
\label{tab:slm_pilot}
\begin{tabular}{ll}
\toprule
